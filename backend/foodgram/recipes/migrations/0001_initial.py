# Generated by Django 3.2.17 on 2023-03-06 18:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(max_length=7, null=True, validators=[django.core.validators.RegexValidator('^#([a-fA-F0-9]{6})', message='Введите HEX-код')], verbose_name='HEX-код')),
